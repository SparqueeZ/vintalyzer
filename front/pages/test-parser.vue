    ...
    <div v-if="result" class="mt-4">
      ...
      <div class="bg-gray-100 p-4 rounded overflow-auto">
        ...
        <div class="mb-4">
          ...
          <p>
            Nombre de vitrines :
            {{ result.marketing?.dressingVitrine?.length || 0 }}
          </p>
        ...
        <div class="mb-4">
          ...
          <p>
            ...
            {{ result.finances?.transferts?.length || 0 }}
          </p>
          <p>
            Solde actuel : {{ result.finances?.soldeActuel?.toFixed(2) || 0 }} €
          </p>
          ...
          <div class="mb-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              >
                <p v-if="ventes > 0">
                  {{ pays }}: {{ ventes }} ventes ({{
                    concurrentResult.analyseVentes.pourcentagesParPays[
                      pays
                    ].toFixed(1)
                  }}%)
                </p>
