...
export const exclusionPatterns = {
  ...
  allemagne:
    /\b(au\s+top|le\s+top|du\s+top|super\s+sympa|super\s+content|super\s+vendeur|top\s+je\s+recommande)\b/i,
  ...
  anglais:
    /\b(bedankt|artikel|zoals|stars|goed|prima|snel|perfect|super|service|kwaliteit|conditie|precies|netjes|correct|proper)\b/i,
};
